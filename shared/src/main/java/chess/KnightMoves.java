...
public class KnightMoves extends FindMoves {
    public KnightMoves() {
    ...
    public Collection<ChessMove> getMoves(ChessBoard board, ChessPosition myPosition) {
        ...
        //Check Spaces
        checkMove(board, myPosition, new ChessPosition(myPosition.getRow()+1,myPosition.getColumn()+2), enemy);
        checkMove(board, myPosition, new ChessPosition(myPosition.getRow()+2,myPosition.getColumn()+1), enemy);
        checkMove(board, myPosition, new ChessPosition(myPosition.getRow()+1,myPosition.getColumn()-2), enemy);
        checkMove(board, myPosition, new ChessPosition(myPosition.getRow()+2,myPosition.getColumn()-1), enemy);
        checkMove(board, myPosition, new ChessPosition(myPosition.getRow()-1,myPosition.getColumn()+2), enemy);
        checkMove(board, myPosition, new ChessPosition(myPosition.getRow()-2,myPosition.getColumn()+1), enemy);
